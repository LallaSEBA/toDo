      ...
      databaseHelper.forgetData(emailController.text.trim())
                    .whenComplete((){
                      if(databaseHelper.status){
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ConfirmCode()));
                        global_email = emailController.text.trim();
                        print(global_email);
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              raisedBtnWidget(str_send, goToConfirmCode, context),
            ],
          ),
        ],
      ) ,
