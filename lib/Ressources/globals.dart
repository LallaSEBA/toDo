...
double paddingBeforTopField(BuildContext context){
  return mainHeight(context)*0.35;               //320/896   //315/896
}
//بين حقول الكتابة
double paddingBetweenFields(BuildContext context){
  return mainHeight(context)*0.052;               // 46.5/896
}
//فوق صورة القفل
...
double paddingUnderImg(BuildContext context){
  return mainHeight(context)*0.05;               // 15/896
}
...
double imgWidth(BuildContext context){
  return mainWidth(context)*0.18;                 // 77.9/414=0.18    108
}
//
double imgHeight(BuildContext context){
  return mainHeight(context)*0.1;                // 108/896  
}
